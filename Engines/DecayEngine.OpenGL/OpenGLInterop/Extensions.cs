...
namespace DecayEngine.OpenGL.OpenGLInterop
{
    ...
    {
        private static bool[] _availableExtensions;
        ...
        public static void ReloadExtensions()
        {
            ...
            else
            {
                ...
                var extensions = GL.GetString(StringName.Extensions).Split(new char[] { '\0', ' ' });
            ...
            _availableExtensions = new bool[extensionNames.Length];

            for (int i = 0; i < extensionNames.Length; i++)
            {
                _availableExtensions[i] = stringExtensions.Contains(extensionNames[i].ToLower());
            }
        }
        ...
        {
            if (_availableExtensions == null) ReloadExtensions();

            // check if the extension is supported
            return _availableExtensions[(int)name];
        }
        ...
        public static bool LXARBRobustnessApplicationIsolation_GLX => IsExtensionSupported(Extension.GLX_ARB_robustness_application_isolation);
        public static bool LXARBRobustnessShareGroupIsolation_GLX => IsExtensionSupported(Extension.GLX_ARB_robustness_share_group_isolation);
        public static bool ARBRobustnessApplicationIsolation_WGL => IsExtensionSupported(Extension.WGL_ARB_robustness_application_isolation);
        ...
        public static bool TransformFeedback3LinesTriangles_AMD => IsExtensionSupported(Extension.GL_AMD_transform_feedback3_lines_triangles);
        ...
        public static bool FramebufferMultisampleBlitScaled_EXT => IsExtensionSupported(Extension.GL_EXT_framebuffer_multisample_blit_scaled);
        ...
        public static bool ConservativeRasterPreSnapTriangles_NV => IsExtensionSupported(Extension.GL_NV_conservative_raster_pre_snap_triangles);
        ...
        public static bool BlendEquationAdvancedMultiDrawBuffers_NVX => IsExtensionSupported(Extension.GL_NVX_blend_equation_advanced_multi_draw_buffers);
