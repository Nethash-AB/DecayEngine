...
namespace DecayEngine.Fmod.Managed.FmodInterop.Studio
{
    ...
    public struct System
    {
        ...
        public RESULT initialize(int maxchannels, INITFLAGS studioflags, FmodInterop.INITFLAGS flags, IntPtr extradriverdata)
        {
        ...
        public RESULT getCoreSystem(out FmodInterop.System coresystem)
        {
        ...
        [DllImport(STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_System_Initialize              (IntPtr system, int maxchannels, INITFLAGS studioflags, FmodInterop.INITFLAGS flags, IntPtr extradriverdata);
        [DllImport(STUDIO_VERSION.dll)]
