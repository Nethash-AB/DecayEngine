...
namespace DecayEngine.SDL2.Native.Sdl2Interop
{
...
#pragma warning restore 0169
		...
		[DllImport(nativeLibName, EntryPoint = "SDL_WinRTGetFSPathUTF8", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr INTERNAL_SDL_WinRTGetFSPathUTF8(SDL_WinRT_Path pathType);
		public static string SDL_WinRTGetFSPathUTF8(SDL_WinRT_Path pathType)
		{
			return UTF8_ToManaged(INTERNAL_SDL_WinRTGetFSPathUTF8(pathType), true);
		}
