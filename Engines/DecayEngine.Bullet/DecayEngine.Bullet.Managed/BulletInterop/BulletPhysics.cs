...
namespace DecayEngine.Bullet.Managed.BulletInterop
{
    public static class BulletPhysics
    {
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern int btCompoundShape_getNumChildShapes(IntPtr obj);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern IntPtr btCompoundShapeChild_getChildShape(IntPtr obj);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btCompoundShape_removeChildShape(IntPtr obj, IntPtr value);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btCompoundShapeChild_delete(IntPtr obj);
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern IntPtr btDbvtAabbMm_FromCE([In] ref Vector3 c, [In] ref Vector3 e);
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern IntPtr btDbvtAabbMm_FromCR([In] ref Vector3 c, float r);
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern IntPtr btDbvtAabbMm_FromMM([In] ref Vector3 mi, [In] ref Vector3 mx);
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern IntPtr btDbvtAabbMm_FromPoints([In] ref Vector3 ppts, int n);
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern IntPtr btDbvtAabbMm_FromPoints2([In] ref Vector3 pts, int n);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btDbvtAabbMm_delete(IntPtr obj);
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btQuantizedBvh_setTraversalMode(IntPtr obj, TraversalMode traversalMode);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern IntPtr btRigidBody_btRigidBodyConstructionInfo_getCollisionShape(IntPtr obj);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btSoftBody_getInitialWorldTransform(IntPtr obj, [Out] out Matrix4 value);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern int btSoftBody_rayTest2(IntPtr obj, [In] ref Vector3 rayFrom, [In] ref Vector3 rayTo, ref float mint, out FeatureType feature, out int index, bool bcountonly);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btSoftBody_setInitialWorldTransform(IntPtr obj, [In] ref Matrix4 value);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern AeroModel btSoftBody_Config_getAeromodel(IntPtr obj);
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern int btSoftBody_Config_getCiterations(IntPtr obj);
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern Collisions btSoftBody_Config_getCollisions(IntPtr obj);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btSoftBody_Config_setAeromodel(IntPtr obj, AeroModel value);
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btSoftBody_Config_setCiterations(IntPtr obj, int value);
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btSoftBody_Config_setCollisions(IntPtr obj, Collisions value);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern JointType btSoftBody_Joint_Type(IntPtr obj);
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern MaterialFlags btSoftBody_Material_getFlags(IntPtr obj);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btSoftBody_Material_setFlags(IntPtr obj, MaterialFlags value);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern FeatureType btSoftBody_sRayCast_getFeature(IntPtr obj);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		[DllImport(Dll, CallingConvention = Conv)]
		public static extern void btSoftBodyHelpers_Draw(IntPtr psb, IntPtr idraw, DrawFlags drawflags);
		[DllImport(Dll, CallingConvention = Conv)]
		...
		public delegate void MotionStateGetWorldTransformDelegate(out Matrix4 worldTransform);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void MotionStateSetWorldTransformDelegate(ref Matrix4 worldTransform);

		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void NearCallbackDelegate(IntPtr collisionPair, IntPtr dispatcher, IntPtr dispatchInfo);

		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate bool NeedBroadphaseCollisionUnmanagedDelegate(IntPtr proxy0, IntPtr proxy1);

		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawAabbUnmanagedDelegate([In] ref Vector3 from, [In] ref Vector3 to, [In] ref Vector3 color);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawArcUnmanagedDelegate([In] ref Vector3 center, [In] ref Vector3 normal, [In] ref Vector3 axis, float radiusA, float radiusB,
			float minAngle, float maxAngle, ref Vector3 color, bool drawSect, float stepDegrees);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawBoxUnmanagedDelegate([In] ref Vector3 bbMin, [In] ref Vector3 bbMax, [In] ref Matrix4 trans, [In] ref Vector3 color);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawCapsuleUnmanagedDelegate(float radius, float halfHeight, int upAxis, [In] ref Matrix4 transform, [In] ref Vector3 color);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawConeUnmanagedDelegate(float radius, float height, int upAxis, [In] ref Matrix4 transform, [In] ref Vector3 color);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawContactPointUnmanagedDelegate([In] ref Vector3 pointOnB, [In] ref Vector3 normalOnB, float distance, int lifeTime, [In] ref Vector3 color);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawCylinderUnmanagedDelegate(float radius, float halfHeight, int upAxis, [In] ref Matrix4 transform, [In] ref Vector3 color);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawLineUnmanagedDelegate([In] ref Vector3 from, [In] ref Vector3 to, [In] ref Vector3 color);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawPlaneUnmanagedDelegate([In] ref Vector3 planeNormal, float planeConst, [In] ref Matrix4 transform, [In] ref Vector3 color);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawSphereUnmanagedDelegate(float radius, [In] ref Matrix4 transform, [In] ref Vector3 color);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawSpherePatchUnmanagedDelegate([In] ref Vector3 center, [In] ref Vector3 up, [In] ref Vector3 axis, float radius,
			float minTh, float maxTh, float minPs, float maxPs, [In] ref Vector3 color, float stepDegrees);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawTransformUnmanagedDelegate([In] ref Matrix4 transform, float orthoLen);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void DrawTriangleUnmanagedDelegate([In] ref Vector3 v0, [In] ref Vector3 v1, [In] ref Vector3 v2, [In] ref Vector3 color, float alpha);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void SimpleCallback(int x);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate DebugDrawFlags GetDebugModeUnmanagedDelegate();

		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate void InternalTickCallbackUnmanaged(IntPtr world, float timeStep);

		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate float RayTraceCallbackAddSingleResultUnmanagedDelegate(IntPtr rayResult, bool normalInWorldSpace);
		[UnmanagedFunctionPointer(Conv), SuppressUnmanagedCodeSecurity]
		public delegate bool RayTraceCallbackNeedsCollisionUnmanagedDelegate(IntPtr proxy0);
    }
}